...
for sample in [1, 10, 20, 'pure']:
    ...
    def bert_generate(given_words, length, pos, turns=1, sample='pure'):
    ...
    for i, text in enumerate(texts):
        ...
        stega_text = bert_generate(given_words, length, pos, turns=turns, sample=sample)
    ...
    with open('./bert-base-uncased-gen/bert-gibbs-' + str(sample) + '-turns-' + str(turns) + '_sample.txt', 'w',
              encoding='UTF-8') as f:
        f.write('\n'.join(stega_texts))
